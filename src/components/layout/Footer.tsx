        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[60px] pb-[60px] border-b border-white/8 mb-9">
          ...
          <div>
            ...
            <ul className="list-none flex flex-col gap-3">
              ...
              <li><Link href="/how-it-works" className="text-[13.5px] text-white/55 no-underline transition-colors duration-300 hover:text-[#44A194]">How It Works</Link></li>
              ...
              <li><Link href="/for-talent" className="text-[13.5px] text-white/55 no-underline transition-colors duration-300 hover:text-[#44A194]">Join as a Specialist</Link></li>
