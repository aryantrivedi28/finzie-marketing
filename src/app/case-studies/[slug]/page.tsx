...
export default function CaseStudyPage() {
  ...
  // Check if there's any content to show in the main content area
  const hasMainContent = caseStudy?.description || 
  ...
  const hasSidebarContent = (caseStudy?.tags && caseStudy.tags.length > 0) ||
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden pt-24">
        <div className="max-w-7xl mx-auto px-4 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Image - Only show if mainImage exists */}
            {caseStudy.mainImage && (
              <motion.div
              ...
              >
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  {/* Video overlay badge - Only show if video exists */}
                  {hasVideo && (
                    <div 
      ...
      {/* Video Section - Only show if video exists and not shown in hero */}
      {hasVideo && caseStudy.mainImage && (
      ...
      {/* Content with Sidebar Layout - Only show if there's main content or sidebar content */}
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            {hasMainContent && (
              <div className="lg:col-span-2 space-y-16">
                ...
                {/* Challenge Section - Only show if challenge exists */}
                {caseStudy.challenge && caseStudy.challenge.length > 0 && (
                  <motion.div 
                    id="challenge" 
                    className="scroll-mt-24"
                ...
                {/* Solution Section - Only show if finzieAdvantage exists */}
                {caseStudy.finzieAdvantage && caseStudy.finzieAdvantage.length > 0 && (
                  <motion.div 
                    id="solution" 
                    className="scroll-mt-24"
                ...
                {/* Results Section - Only show if snapshot exists */}
                {caseStudy.snapshot && caseStudy.snapshot.length > 0 && (
                  <motion.div 
                    id="results" 
                    className="scroll-mt-24"
            ...
            {/* Sidebar - Only show if there's sidebar content */}
            {hasSidebarContent && (
              <div className="space-y-8">
                <div className="sticky top-32 space-y-8">
                  {/* Quick Stats Card - Only show if tags exist */}
                  {caseStudy.tags && caseStudy.tags.length > 0 && (
                    <motion.div 
                  ...
                  {/* Team Member - Only show if teamMember exists */}
                  {caseStudy.teamMember && (
                    <motion.div 
                      className="bg-white rounded-2xl p-6 border border-teal/10 shadow-sm"
                      initial={{ opacity: 0, x: 30 }}
                  ...
                  {/* CTA Card - Only show if callToActionButton exists */}
                  {caseStudy.callToActionButton && (
                    <motion.div 
      ...
      {/* Bottom CTA Section - Always show */}
