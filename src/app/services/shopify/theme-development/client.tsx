...
export default function ThemeDevelopmentClient() {

    const includedItems = [
        { icon: Palette, title: 'Custom Theme Design', description: 'Unique design tailored to your brand identity. No templates. No copy-paste. Built from scratch or customizing existing themes.' },
        { icon: Code, title: 'Liquid Development', description: 'Expert Liquid coding for custom sections, dynamic content, and advanced functionality beyond theme limitations.' },
        { icon: Smartphone, title: 'Mobile-First Approach', description: 'Fully responsive designs that look perfect on all devices. Mobile optimization is priority, not an afterthought.' },
        { icon: Gauge, title: 'Performance Optimization', description: 'Fast loading themes with optimized code, lazy loading, and image optimization for Core Web Vitals compliance.' },
        { icon: Settings, title: 'Theme Customization', description: 'Customize any existing theme to match your brand. Modify layouts, colors, fonts, and functionality.' },
        { icon: TestTube, title: 'Cross-Browser Testing', description: 'Thorough testing on Chrome, Safari, Firefox, Edge to ensure consistent experience across all browsers.' },
        { icon: Layout, title: 'Section-Based Builder', description: 'Custom sections for Shopify 2.0 allowing drag-and-drop page building. Easy content management.' },
        { icon: Plug, title: 'Third-Party Integrations', description: 'Integrate reviews, wishlist, loyalty, and any third-party apps seamlessly into your theme.' },
        { icon: GraduationCap, title: 'Theme Documentation', description: 'Complete documentation and training on managing your new theme. Post-launch support included.' },
    ];
                    ...
                    <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-14 items-center">
                        ...
                        <div>
                            <div className="bg-white/10 border border-white/15 rounded-2xl p-5 sm:p-6 md:p-8">
                                <h3 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-white/50 mb-4 sm:mb-5">Theme Stats</h3>
                                <div className="space-y-2 sm:space-y-3">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 py-2 sm:py-3 border-b border-white/10">
                                        ...
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Custom themes delivered</div>
                                    </div>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 py-2 sm:py-3 border-b border-white/10">
                                        <div className="text-xl sm:text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] sm:min-w-[80px]">99%</div>
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Client satisfaction rate</div>
                                    </div>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 py-2 sm:py-3 border-b border-white/10">
                                        <div className="text-xl sm:text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] sm:min-w-[80px]">2-4 weeks</div>
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Typical development time</div>
                                    </div>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 py-2 sm:py-3">
                                        ...
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Mobile-responsive designs</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                        <div className="text-center md:text-left">
                            ...
                            <div className="space-y-2 sm:space-y-2.5 mt-4 sm:mt-5">
                                {[
                                    'Wanting a unique design that stands out from competitors',
                                    'Needing custom functionality not available in themes',
                                    'Current theme is slow, buggy, or difficult to manage',
                                    'Looking to improve conversion with better UX design',
                                    'Scaling your brand and need a professional, custom store',
                                ].map((item, idx) => (
                        ...
                        <div>
                            <div className="bg-[#1C2321] rounded-2xl p-5 sm:p-6 md:p-8 text-white">
                                <h3 className="text-base sm:text-[1.1rem] font-bold mb-3 sm:mb-4">The Cost of Generic Themes</h3>
                                <p className="text-sm sm:text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Off-the-shelf themes are used by thousands of stores. Your brand blends in. Worse, they come with bloated code that slows down your site and hurts conversions.</p>
                                <p className="text-sm sm:text-[0.85rem] font-light text-white/60 leading-relaxed mb-4 sm:mb-5">Custom themes load 40% faster on average and convert 25% better than generic templates. One-time investment, lifetime advantage.</p>
                                <div className="space-y-2 sm:space-y-3">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                                        ...
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Faster load times with custom code</div>
                                    </div>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                                        <div className="text-lg sm:text-[1.3rem] font-extrabold text-[#44A194] sm:min-w-[70px]">25%</div>
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Higher conversion rate vs generic themes</div>
                                    </div>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                                        <div className="text-lg sm:text-[1.3rem] font-extrabold text-[#44A194] sm:min-w-[70px]">3-5x</div>
                                        <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">ROI from custom theme investment</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 sm:py-16 md:py-20 bg-[#F4F0E4]">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center md:text-left max-w-[600px] mb-8 md:mb-12 mx-auto md:mx-0">
                        ...
                        <p className="text-sm sm:text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A proven 5-step process from concept to launch.</p>
                    </div>
