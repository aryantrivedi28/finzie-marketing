...
export default function StoreSetupClient() {
  ...
  const includedItems = [
    { icon: Store, title: 'Full Store Setup', description: 'Complete Shopify store configuration from scratch including theme selection, branding, and basic settings.' },
    { icon: Package, title: 'Product Migration', description: 'Migrate all products with images, variants, inventory, SEO metadata, and collections intact.' },
    { icon: Users, title: 'Customer Data Transfer', description: 'Secure transfer of customer accounts, order history, and passwords with zero data loss.' },
    { icon: FileText, title: 'Content Migration', description: 'Migrate blog posts, pages, and other content from your existing platform to Shopify.' },
    { icon: LinkIcon, title: 'Domain & Payment Setup', description: 'Custom domain configuration, SSL setup, and payment gateway integration (Stripe, PayPal, Shopify Payments).' },
    { icon: Settings, title: 'Shipping & Tax Config', description: 'Complete shipping zones, rates configuration, and tax settings automation.' },
    { icon: Smartphone, title: 'Mobile Optimization', description: 'Mobile-responsive design optimization ensuring perfect display on all devices.' },
    { icon: Plug, title: 'Essential Apps Setup', description: 'Install and configure essential Shopify apps for email, reviews, wishlist, and analytics.' },
    { icon: GraduationCap, title: '30 Days Support', description: 'Post-launch support including training, bug fixes, and priority assistance.' },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2 sm:space-y-2.5 mt-4 sm:mt-5">
                {[
                  'Currently on WooCommerce, Magento, or BigCommerce looking to upgrade',
                  'Launching a new ecommerce store from scratch',
                  'Moving from Shopify 1.0 to Shopify 2.0',
                  'Reorganizing an existing messy Shopify store',
                  'Needing custom setup with specific apps and integrations',
                ].map((item, idx) => (
            ...
            <div>
              <div className="bg-[#1C2321] rounded-2xl p-5 sm:p-6 md:p-8 text-white">
                <h3 className="text-base sm:text-[1.1rem] font-bold mb-3 sm:mb-4">The Cost of Staying</h3>
                <p className="text-sm sm:text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Staying on an outdated or slow platform costs you sales every day. Slow loading times, poor mobile experience, and limited features directly impact your conversion rate.</p>
                <p className="text-sm sm:text-[0.85rem] font-light text-white/60 leading-relaxed mb-4 sm:mb-5">Shopify stores see an average 30% increase in conversion rate after migration from other platforms. Better speed, better checkout, better results.</p>
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                    <div className="text-lg sm:text-[1.3rem] font-extrabold text-[#44A194] sm:min-w-[70px]">30%</div>
                    <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Higher conversion rate on Shopify</div>
                  </div>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                    <div className="text-lg sm:text-[1.3rem] font-extrabold text-[#44A194] sm:min-w-[70px]">2x</div>
                    <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Faster load times after migration</div>
                  </div>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 py-2 sm:py-3 border-t border-white/10">
                    <div className="text-lg sm:text-[1.3rem] font-extrabold text-[#44A194] sm:min-w-[70px]">45+</div>
                    <div className="text-[0.7rem] sm:text-[0.78rem] text-white/50">Successful store launches</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#F4F0E4]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center md:text-left max-w-[600px] mb-8 md:mb-12 mx-auto md:mx-0">
            ...
            <p className="text-sm sm:text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A proven 5-step process for seamless migration with zero downtime.</p>
          </div>
