          ...
          <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 md:gap-14 items-center">
            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                <h3 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-white/50 mb-5">TikTok Ads Stats</h3>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">1B+</div>
                ...
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  ...
                  <div className="text-[0.78rem] text-white/50">Higher engagement than other platforms</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">40%</div>
                  <div className="text-[0.78rem] text-white/50">Lower CPM than Meta</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">35+</div>
                  <div className="text-[0.78rem] text-white/50">Active TikTok campaigns</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]" id="included">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: '🎬', title: 'Creative Strategy', description: 'TikTok-native creative strategy. We help you create scroll-stopping videos that feel native to the platform.' },
              { icon: '🎯', title: 'Audience Targeting', description: 'Target by interests, behaviors, hashtags, creators, and custom audiences. Reach your ideal TikTok audience.' },
              { icon: '💰', title: 'Budget Optimization', description: 'Smart budget allocation across awareness, consideration, and conversion objectives.' },
              { icon: '🎵', title: 'Trend Integration', description: 'We leverage trending sounds, effects, and formats to maximize organic reach and engagement.' },
              { icon: '🤝', title: 'Creator Partnership', description: 'Connect with TikTok creators for authentic sponsored content that resonates with their followers.' },
              { icon: '📈', title: 'Performance Tracking', description: 'Complete pixel setup, conversion tracking, and analytics for accurate attribution.' },
              { icon: '🧪', title: 'Creative Testing', description: 'A/B test different hooks, formats, and calls-to-action to find winning creative.' },
              { icon: '📋', title: 'Weekly Reporting', description: 'Detailed reports showing spend, impressions, CTR, CPC, conversions, and ROAS.' },
              { icon: '⚡', title: 'Community Engagement', description: 'Monitor comments and engage with users who interact with your ads.' },
            ].map((item, index) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <ul className="list-none flex flex-col gap-2.5 mt-5">
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Targeting Gen Z or Millennial audiences</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Selling visually appealing products (fashion, beauty, gadgets)</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Wanting to go viral and build brand awareness quickly</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Current platforms are getting too expensive</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Ready to create engaging video content</li>
              </ul>
            </div>
            <div>
              <div className="bg-[#1C2321] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The TikTok Opportunity</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">TikTok's algorithm rewards engaging content, not high budgets. Small brands can go viral overnight. CPMs are 40% lower than Meta, giving you more reach for your budget.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Early adopters are winning. Don't wait until competition drives up costs like other platforms.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">1B+</div>
                  <div className="text-[0.78rem] text-white/50">Monthly active users</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">40%</div>
                  <div className="text-[0.78rem] text-white/50">Lower CPM than Facebook</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <p className="text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A creative-first approach to TikTok advertising.</p>
          </div>
