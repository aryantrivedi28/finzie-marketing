            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                ...
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">930M+</div>
                  <div className="text-[0.78rem] text-white/50">Professional members</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">4/5</div>
                  <div className="text-[0.78rem] text-white/50">Decision makers on LinkedIn</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">2x</div>
                  <div className="text-[0.78rem] text-white/50">Higher conversion than other platforms</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">50+</div>
                  <div className="text-[0.78rem] text-white/50">B2B campaigns managed</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]" id="included">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: '🎯', title: 'Professional Targeting', description: 'Target by job title, function, seniority, company name, industry, company size, and more. Reach exact decision makers.' },
              { icon: '📝', title: 'Lead Gen Forms', description: 'Pre-filled LinkedIn lead forms that convert at 2-3x higher rate than landing pages. Capture quality leads directly.' },
              { icon: '🎨', title: 'Sponsored Content', description: 'Promote posts in the LinkedIn feed. Build awareness and drive engagement with professional audiences.' },
              { icon: '✉️', title: 'Sponsored InMail', description: 'Send personalized messages directly to target audience inboxes. 50%+ open rates for B2B campaigns.' },
              { icon: '📊', title: 'Text & Dynamic Ads', description: 'Personalized ads that show your brand alongside the user\'s profile photo. High CTR for B2B.' },
              { icon: '🔗', title: 'Account-Based Marketing', description: 'Target specific companies with account lists. Run coordinated campaigns to key accounts.' },
              { icon: '📈', title: 'Conversion Tracking', description: 'Track leads, form fills, and downstream conversions with LinkedIn Insight Tag and API.' },
              { icon: '📋', title: 'Audience Retargeting', description: 'Retarget website visitors and engaged audiences with LinkedIn Matched Audiences.' },
              { icon: '📊', title: 'Monthly Reporting', description: 'Detailed lead reports with contact information, campaign metrics, and ROI analysis.' },
            ].map((item, index) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <ul className="list-none flex flex-col gap-2.5 mt-5">
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Selling B2B products or services</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Needing to reach specific job titles or companies</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Running Account-Based Marketing campaigns</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Targeting senior executives and decision makers</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Generating high-value leads for sales teams</li>
              </ul>
            </div>
            <div>
              <div className="bg-[#1C2321] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The B2B Advertising Advantage</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Other platforms can't match LinkedIn's professional targeting. You can reach exactly the decision makers you need - by job title, company, seniority, and industry.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Higher CPMs but higher conversion rates. Quality over quantity for B2B. Our clients see 2x higher lead quality compared to other platforms.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">4/5</div>
                  <div className="text-[0.78rem] text-white/50">Decision makers use LinkedIn</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                ...
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  ...
                  <div className="text-[0.78rem] text-white/50">InMail open rates</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <p className="text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A strategic approach to B2B lead generation.</p>
          </div>
