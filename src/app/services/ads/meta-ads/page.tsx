          ...
          <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 md:gap-14 items-center">
            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                <h3 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-white/50 mb-5">Meta Ads Stats</h3>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">50+</div>
                  <div className="text-[0.78rem] text-white/50">Active campaigns managed</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                ...
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  ...
                  <div className="text-[0.78rem] text-white/50">Lower CPA on average</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">24/7</div>
                  <div className="text-[0.78rem] text-white/50">Campaign monitoring</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]" id="included">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: '📊', title: 'Campaign Strategy', description: 'Data-driven strategy development based on your goals, audience, and budget. We find the winning approach before spending.' },
              { icon: '🎨', title: 'Ad Creative Development', description: 'High-converting ad copy, images, and video creatives tested for engagement and conversion.' },
              { icon: '🎯', title: 'Audience Targeting', description: 'Precise targeting using interests, behaviors, lookalikes, and retargeting to reach ideal customers.' },
              { icon: '💰', title: 'Budget Optimization', description: 'Smart budget allocation across campaigns, ad sets, and ads for maximum ROAS.' },
              { icon: '🧪', title: 'A/B Testing', description: 'Continuous testing of creatives, copy, audiences, and placements to improve performance.' },
              { icon: '📈', title: 'Performance Tracking', description: 'Complete tracking setup including pixel, conversions API, and custom events for accurate attribution.' },
              { icon: '🤖', title: 'Automated Rules', description: 'Smart automation rules to pause underperforming ads and scale winning campaigns.' },
              { icon: '📋', title: 'Weekly Reporting', description: 'Detailed reports showing spend, results, ROAS, and actionable insights for improvement.' },
              { icon: '💬', title: 'Creative Refresh', description: 'Regular creative updates to prevent ad fatigue and maintain performance.' },
            ].map((item, index) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <ul className="list-none flex flex-col gap-2.5 mt-5">
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Wanting to scale customer acquisition profitably</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Currently running ads but not seeing ROI</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Not sure how to target your ideal customers</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Spending too much time managing ads yourself</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Ready to scale to $10k+ monthly ad spend</li>
              </ul>
            </div>
            <div>
              <div className="bg-[#1C2321] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The Cost of Poor Ad Management</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Bad targeting, poor creative, and no testing = wasted ad spend. Most businesses waste 30-50% of their budget on underperforming campaigns.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Professional management turns wasted spend into profitable growth. Our clients see 3x+ ROAS on average.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">30-50%</div>
                  <div className="text-[0.78rem] text-white/50">Wasted budget without optimization</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">3.2x</div>
                  <div className="text-[0.78rem] text-white/50">Average ROAS achieved</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">20+ hrs</div>
                  <div className="text-[0.78rem] text-white/50">Saved weekly on ad management</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <p className="text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A data-driven approach to profitable ad scaling.</p>
          </div>
