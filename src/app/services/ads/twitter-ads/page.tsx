            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                ...
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">500M+</div>
                  <div className="text-[0.78rem] text-white/50">Monthly active users</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">80%</div>
                  <div className="text-[0.78rem] text-white/50">Users on mobile</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">3x</div>
                  <div className="text-[0.78rem] text-white/50">Higher engagement for Promoted Tweets</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#44A194] tracking-[-0.03em] min-w-[80px]">30+</div>
                  <div className="text-[0.78rem] text-white/50">Active campaigns</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]" id="included">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: '🐦', title: 'Promoted Tweets', description: 'Boost your best organic tweets to reach larger audiences. Amplify content that is already resonating.' },
              { icon: '📈', title: 'Follower Growth', description: 'Targeted campaigns to grow your follower base with relevant users interested in your niche.' },
              { icon: '🔍', title: 'Keyword Targeting', description: 'Target users tweeting about or searching for specific keywords related to your business.' },
              { icon: '👥', title: 'Follower Targeting', description: 'Target users who follow specific accounts (competitors, influencers, industry leaders).' },
              { icon: '🎯', title: 'Interest Targeting', description: 'Reach users based on their interests, behaviors, and what they engage with on Twitter.' },
              { icon: '📱', title: 'App Install Campaigns', description: 'Drive mobile app installs and engagements with Twitter\'s app promotion formats.' },
              { icon: '📊', title: 'Conversion Tracking', description: 'Twitter Pixel setup to track website conversions, purchases, and lead events.' },
              { icon: '💬', title: 'Engagement Optimization', description: 'Optimize for likes, retweets, replies, and profile visits to build brand presence.' },
              { icon: '📋', title: 'Weekly Reporting', description: 'Detailed performance reports showing impressions, engagement, CTR, and conversions.' },
            ].map((item, index) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <ul className="list-none flex flex-col gap-2.5 mt-5">
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> A media, news, or content brand</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Launching a product or major announcement</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Wanting to build brand authority and thought leadership</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Targeting tech-savvy, engaged audiences</li>
                <li className="flex gap-2.5 text-[0.85rem] font-normal text-[#8a8a82] leading-relaxed"><span className="text-[#44A194] font-bold flex-shrink-0">✓</span> Needing real-time engagement around events</li>
              </ul>
            </div>
            <div>
              <div className="bg-[#1C2321] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The Conversation Advantage</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Twitter users are actively looking for news, opinions, and conversations. They're engaged and ready to interact. Promoted Tweets see 3x higher engagement than organic.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Real-time relevance is key. We help you join conversations when they matter most.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">3x</div>
                  <div className="text-[0.78rem] text-white/50">Higher engagement than organic</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">80%</div>
                  <div className="text-[0.78rem] text-white/50">Users on mobile</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#44A194] min-w-[70px]">Real-time</div>
                  <div className="text-[0.78rem] text-white/50">Engagement when it matters</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F0E4]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <p className="text-[0.9rem] font-light text-[#8a8a82] leading-relaxed">A real-time approach to Twitter advertising.</p>
          </div>
