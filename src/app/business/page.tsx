...
const ForBusinessPage = () => {
  ...
  return (
    <main className="flex-1 min-h-screen bg-[#F4F0E4] overflow-x-hidden">
      ...
      <div 
        data-section="stats"
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 border-t border-[rgba(28,35,33,0.08)]"
      >
        {stats.map((stat, index) => (
          <motion.div
            key={stat.label}
            initial="hidden"
            animate={hasAnimated.stats ? "visible" : "hidden"}
            variants={fadeInUp}
            className="p-8 sm:p-10 md:p-11 border-b sm:border-b-0 sm:border-r border-[rgba(28,35,33,0.08)] last:border-r-0 text-center sm:text-left"
          >
      ...
      <section 
        ...
        className="px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 border-t border-[rgba(28,35,33,0.08)]"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-20 items-start">
            <motion.div
              initial="hidden"
              animate={hasAnimated.services ? "visible" : "hidden"}
              variants={fadeInUp}
            >
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
            animate={hasAnimated.comparison ? "visible" : "hidden"}
            variants={fadeInUp}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-[60px] items-center">
            <motion.div
              initial="hidden"
              animate={hasAnimated.aiVetting ? "visible" : "hidden"}
              variants={fadeInUp}
            >
              <span className="inline-block bg-[rgba(68,161,148,0.1)] text-[#44A194] text-[9px] sm:text-[10px] tracking-[0.22em] uppercase px-3 py-1.5 mb-4 sm:mb-5">
                AI-Powered Vetting
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
            animate={hasAnimated.testimonials ? "visible" : "hidden"}
            variants={fadeInUp}
